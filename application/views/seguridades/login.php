...
<html lang="es" dir="ltr">
  <head>
    <meta charset="utf-8">
    <!-- importacion para dispositivos moviles responsibilidad  -->
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-md-4" id='cuadroLogin'>
            <center>
                <h3>
            ...
            <fieldset>
              ...
              <div class="form-group">
                <label class="col-md-4 control-label" for="email_usu_aaa">Email:</label>
                <div class="col-md-6">
                <input id="email_usu_aaa" name="email_usu_aaa" type="text" placeholder="Ingrese su email" class="form-control input-md" required="">
                <span class="help-block">Ingrese su usuario</span>
                </div>
              </div>

              <!-- Password input-->
              <div class="form-group">
                <label class="col-md-4 control-label" for="password_usu_aaa">Contraseña:</label>
                <div class="col-md-6">
                  <input id="password_usu_aaa" name="password_usu_aaa" type="password" placeholder="Ingrese su contraseña" class="form-control input-md" required="">
